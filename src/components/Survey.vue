<template>
  <div class="survey">
      ...
      <form v-on:submit.prevent="validateForm">
        <p><label for="q1">How long have you been building websites?<br><input type="text" id="q1" v-model="q1"></label></p>
        <p>What languages interest you the most?<br>
          <label v-for="language in languageOptions">
            <input type="checkbox" v-model="q2" v-bind:value="language.value">
            {{ language.text }}
          </label>
        </p>
        <p>What other topics interest you?<br>
        ...
        <p>
          <label for="q4">What kinds of websites would you like to build someday?<br>
            <textarea cols="70" rows="8" id="q4" v-model="q4" placeholder="Type your response here."></textarea>
          </label>
        </p>
        <p>
          <label for="q5">Spaces or Tabs?
            <select v-model="q5" id="q5">

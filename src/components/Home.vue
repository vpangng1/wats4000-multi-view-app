<template>
  <div class="home">
    <div v-show="showForm" class="form-container">
      ...
      <p v-show="showError" class="error">There are errors in the form data you have submitted.</p>
      ...
      <form v-on:submit.prevent="validateForm">
        ...
        <input type="password" id="passwordVerify" v-model="passwordVerify" placeholder="Confirm your password.">
        </label>
